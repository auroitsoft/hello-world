...
function employeessearch()
{
	...
	var params = 'search_str='+search_str+'&limit='+limit+'&offset='+offset+'&flag='+0+'&empflag='+empflag+'&clearflag='+0;
...
function clearSearchData()
{
	...
	$('#s2id_search_val').find('span').html('Employee Name');
	// $("#role_div").css('display','none');
	// $('#search_div').css('display','none');
	$('#search_val').val('emp_name');
	$('#search_str').val('');
	$('#role_id').val('');
